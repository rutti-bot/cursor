...
| 111 | `http:MakeRequest` (GET) | Fetches each line item's properties from HubSpot CRM API (`name`, `quantity`, `price`, `amount`, `hs_product_id`, `hs_sku`, `description`, `hs_discount_percentage`, etc.) |
